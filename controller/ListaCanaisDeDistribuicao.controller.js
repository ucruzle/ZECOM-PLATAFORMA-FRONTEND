sap.ui.define([
	...
	return Controller.extend("sap.ecom.plataforma.controller.ListaCanaisDeDistribuicao", {
		...
		onAtualizarConsulta: function() {
			...
			var oModel  = null;
			var CanaisDeDistribuicao = [];
			var CanalDeDistribuicao  = {};
			...
			CanaisDeDistribuicao.push(CanalDeDistribuicao);
			...
			var oData = {
				CanaisDeDistribuicao: CanaisDeDistribuicao,
				Status: [],
				navigation: [
					{
						title: 'Início',
		...
		onbtnCriarCanalDeDistribuicao: function() {
			this._showCanalDeDistribuicaoFragment();
		},

		onEditDetalheCanalDeDistribuicao: function(oEvent) {
			this._showCanalDeDistribuicaoFragment();
		},

		onGravarCanalDeDistribuicao: function(oEvent) {
			this.onCloseCanalDeDistribuicao();
		},

		onCloseCanalDeDistribuicao: function() {
			this._activeScreen = "view";
			this._CanalDeDistribuicaoFragment.close();
		},

		_showCanalDeDistribuicaoFragment: function() {

			if (!this._CanalDeDistribuicaoFragment) {
				this._CanalDeDistribuicaoFragment = sap.ui.xmlfragment("CanalDeDistribuicaoFragment",
					"sap.ecom.plataforma.view.ListaCanaisDeDistribuicao.fragments.GeraCanalDeDistribuicao", // GeraCanalDeDistribuicao.fragment.xml
					this
				);
				this.getView().addDependent(this._CanalDeDistribuicaoFragment);
			}
			this._CanalDeDistribuicaoFragment.open();
		},
