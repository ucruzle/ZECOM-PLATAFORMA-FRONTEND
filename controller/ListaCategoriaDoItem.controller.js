sap.ui.define([
	...
	return Controller.extend("sap.ecom.plataforma.controller.ListaCategoriaDoItem", {
		...
		onbtnCriarPreco: function() {
			this._showPrecoFragment();
		},

		onEditDetalhePreco: function(oEvent) {
			this._showPrecoFragment();
		},

		onGravarPreco: function(oEvent) {
			this.onClosePreco();
		},

		onClosePreco: function() {
			this._activeScreen = "view";
			this._PrecoFragment.close();
		},

		_showPrecoFragment: function() {

			if (!this._PrecoFragment) {
				this._PrecoFragment = sap.ui.xmlfragment("PrecoFragment",
					"sap.ecom.plataforma.view.ListaCategoriaDoItem.fragments.GeraPreco",
					this
				);
				this.getView().addDependent(this._PrecoFragment);
			}
			this._PrecoFragment.open();
		},
