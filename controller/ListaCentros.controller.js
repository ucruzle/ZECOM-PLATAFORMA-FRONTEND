sap.ui.define([
	...
	return Controller.extend("sap.ecom.plataforma.controller.ListaCentros", {
		...
		onbtnCriarCentro: function() {
			this._showCentroFragment();
		},

		onEditDetalheCentro: function(oEvent) {
			this._showCentroFragment();
		},

		onGravarCentro: function(oEvent) {
			this.onCloseCentro();
		},

		onCloseCentro: function() {
			this._activeScreen = "view";
			this._CentroFragment.close();
		},

		_showCentroFragment: function() {

			if (!this._CentroFragment) {
				this._CentroFragment = sap.ui.xmlfragment("CentroFragment",
					"sap.ecom.plataforma.view.ListaCentros.fragments.GeraCentro",
					this
				);
				this.getView().addDependent(this._CentroFragment);
			}
			this._CentroFragment.open();
		},
