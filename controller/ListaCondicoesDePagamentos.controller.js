sap.ui.define([
	...
	return Controller.extend("sap.ecom.plataforma.controller.ListaCondicoesDePagamentos", {
		...
		onAtualizarConsulta: function() {
			...
			CondicoesPagamentos.push(CondicaoDePagamento);
			...
			var oData = {
				CondicoesPagamentos: CondicoesPagamentos,
				Status: [],
				navigation: [
					{
						title: 'Início',
		...
		onbtnCriarCondicaoDePagamento: function() {
			this._showCondicaoDePagamentoFragment();
		},

		onEditDetalheCondicaoDePagamento: function(oEvent) {
			this._showCondicaoDePagamentoFragment();
		},

		onGravarCondicaoDePagamento: function(oEvent) {
			this.onCloseCondicaoDePagamento();
		},

		onCloseCondicaoDePagamento: function() {
			this._activeScreen = "view";
			this._CondicaoDePagamentoFragment.close();
		},

		_showCondicaoDePagamentoFragment: function() {

			if (!this._CondicaoDePagamentoFragment) {
				this._CondicaoDePagamentoFragment = sap.ui.xmlfragment("CondicaoDePagamentoFragment",
					"sap.ecom.plataforma.view.ListaCondicoesDePagamentos.fragments.GeraCondicaoDePagamento", 
					this
				);
				this.getView().addDependent(this._CondicaoDePagamentoFragment);
			}
			this._CondicaoDePagamentoFragment.open();
		},
