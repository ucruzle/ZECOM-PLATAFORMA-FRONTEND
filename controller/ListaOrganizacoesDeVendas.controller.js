sap.ui.define([
	...
	return Controller.extend("sap.ecom.plataforma.controller.ListaOrganizacoesDeVendas", {
		...
		onAtualizarConsulta: function() {
			...
			var oModel  = null;
			var OrganizacoesDeVendas = [];
			var OrganizacaoDeVenda  = {};
			...
			OrganizacoesDeVendas.push(OrganizacaoDeVenda);
			...
			var oData = {
				OrganizacoesDeVendas: OrganizacoesDeVendas,
				Status: [],
				navigation: [
					{
						title: 'Início',
		...
		onbtnCriarOrganizacaoDeVenda: function() {
			this._showOrganizacaoDeVendaFragment();
		},

		onEditDetalheOrganizacaoDeVenda: function(oEvent) {
			this._showOrganizacaoDeVendaFragment();
		},

		onGravarOrganizacaoDeVenda: function(oEvent) {
			this.onCloseOrganizacaoDeVenda();
		},

		onCloseOrganizacaoDeVenda: function() {
			this._activeScreen = "view";
			this._OrganizacaoDeVendaFragment.close();
		},

		_showOrganizacaoDeVendaFragment: function() {

			if (!this._OrganizacaoDeVendaFragment) {
				this._OrganizacaoDeVendaFragment = sap.ui.xmlfragment("OrganizacaoDeVendaFragment",
					"sap.ecom.plataforma.view.ListaOrganizacoesDeVendas.fragments.GeraOrganizacaoDeVenda",
					this
				);
				this.getView().addDependent(this._OrganizacaoDeVendaFragment);
			}
			this._OrganizacaoDeVendaFragment.open();
		},
