sap.ui.define([
	...
	return Controller.extend("sap.ecom.plataforma.controller.ListaParceiros", {
		...
		onbtnCriarParceiro: function() {
			this._showParceiroFragment();
		},

		onEditDetalheParceiro: function(oEvent) {
			this._showParceiroFragment();
		},

		onGravarParceiro: function(oEvent) {
			this.onCloseParceiro();
		},

		onCloseParceiro: function() {
			this._activeScreen = "view";
			this._ParceiroFragment.close();
		},

		_showParceiroFragment: function() {

			if (!this._ParceiroFragment) {
				this._ParceiroFragment = sap.ui.xmlfragment("ParceiroFragment",
					"sap.ecom.plataforma.view.ListaParceiros.fragments.GeraParceiro",
					this
				);
				this.getView().addDependent(this._ParceiroFragment);
			}
			this._ParceiroFragment.open();
		},
