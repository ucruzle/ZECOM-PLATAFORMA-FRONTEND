sap.ui.define([
	...
	return Controller.extend("sap.ecom.plataforma.controller.ListaTiposDeOrdensVendas", {
		...
		onAtualizarConsulta: function() {
			...
			var oModel  = null;
			var TiposDeOrdensVendas = [];
			var TipoDeOrdemVenda  = {};
			...
			TiposDeOrdensVendas.push(TipoDeOrdemVenda);
			...
			var oData = {
				TiposDeOrdensVendas: TiposDeOrdensVendas,
				Status: [],
				navigation: [
					{
						title: 'Início',
		...
		onbtnCriarTipoDeOrdemVenda: function() {
			this._showTipoDeOrdemVendaFragment();
		},

		onEditDetalheTipoDeOrdemVenda: function(oEvent) {
			this._showTipoDeOrdemVendaFragment();
		},

		onGravarTipoDeOrdemVenda: function(oEvent) {
			this.onCloseTipoDeOrdemVenda();
		},

		onCloseTipoDeOrdemVenda: function() {
			this._activeScreen = "view";
			this._TipoDeOrdemVendaFragment.close();
		},

		_showTipoDeOrdemVendaFragment: function() {

			if (!this._TipoDeOrdemVendaFragment) {
				this._TipoDeOrdemVendaFragment = sap.ui.xmlfragment("TipoDeOrdemVendaFragment",
					"sap.ecom.plataforma.view.ListaTiposDeOrdensVendas.fragments.GeraTipoDeOrdem",
					this
				);
				this.getView().addDependent(this._TipoDeOrdemVendaFragment);
			}
			this._TipoDeOrdemVendaFragment.open();
		},
